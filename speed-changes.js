...
var waikanaeRoads = 
{
	...
	'TE HAPUA ROAD AND SIDE ROADS - Te Hapua Road': [{
		...
		'Current': '80',
		'Proposed': '60',
		'Rationale': 'The proposed 60 km/h speed limit is considered to best reflect the safety and use of Te Hapua Road, which is a windy rural residential no-exit road, and the short adjoining no-exit Tweeddale Road.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map6-reikorangi.gif',
		'ImageBlurb': '<strong>Reikorangi Road</strong> "70" section',
		'PdfUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/pdf/map6-reikorangi.pdf',
		'PdfName': 'Map 6: Reikorangi, Waikanae'
	}],
	'TE HAPUA ROAD AND SIDE ROADS - Tweeddale Road': [{/*---------remove--------*/
		'Road': 'Tweeddale Road',
		'FromTo': 'Full length: From Te Hapua Road to end (324m)',
		'Current': '80',
		'Proposed': '60',
		'Rationale': 'The proposed 60 km/h speed limit is considered to best reflect the safety and use of Te Hapua Road, which is a windy rural residential no-exit road, and the short adjoining no-exit Tweeddale Road.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map6-reikorangi.gif',
...
var otakiRoads = 
{
	...
	'TE HAPUA ROAD AND SIDE ROADS - Puruaha Road': [{
		...
		'Current': '80',
		'Proposed': '60',
		'Rationale': 'The proposed 60 km/h speed limit is considered the safe and appropriate speed limit for Purahau Road and adjoining short Mahurenga Lane, which both have rural residential',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map2-maungakotukutuku-valley-road.gif',
		'ImageBlurb': '221 <strong>Valley Road</strong> to <strong>Waterfall Road</strong> and all of <strong>Maungakotukutuku Road</strong>',
		'PdfUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/pdf/map2-maungakotukutuku-valley-road.pdf',
		'PdfName': 'Map 2: Maungakotukutuku Road and Valley Road'
	...
	'TE HORO BEACH SETTLEMENT - Te Horo Beach Road': [{
		'Road': 'Te Horo Beach Road',
		'FromTo': 'From start of 50 km/h speed limit sign to end (405m).',
		'Current': '50',
		'Proposed': '40',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map2-maungakotukutuku-valley-road.gif',
		'ImageBlurb': '"70" section of <strong>Valley Road</strong>.',
		'PdfUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/pdf/map2-maungakotukutuku-valley-road.pdf',
		'PdfName': 'Map 2: Maungakotukutuku Road and Valley Road'
	}],
	'TE HORO BEACH SETTLEMENT - Gawler Street': [{
		'Road': 'Gawler Street',
		'FromTo': 'Full length: From Kitchener Street to end (659m)',
		'Current': '50',
		'Proposed': '40',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map3-poplar-ave-option1.gif',
	...
	'TE HORO BEACH SETTLEMENT - Dixie Street': [{
		'Road': 'Dixie Street',
		'FromTo': 'Full length: From Te Horo Beach Road to end (223m)',
		'Current': '50',
		'Proposed': '40',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map4-garden-road.gif',
	...
	'TE HORO BEACH SETTLEMENT - Rodney Avenue': [{
		'Road': 'Rodney Avenue',
		'FromTo': 'Full length: From Te Horo Beach Road to end (716m)',
		'Current': '40',
		'Proposed': '30',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map5-nikau-valley.gif',
	...
	'TE HORO BEACH SETTLEMENT - Kitchener Street': [{
		'Road': 'Kitchener Street',
		'FromTo': 'Full length: From Kitchener Street to end (375m)',
		'Current': '50',
		'Proposed': '40',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map5-nikau-valley.gif',
	...
	'TE HORO BEACH SETTLEMENT - Nicholas Street': [{
		'Road': 'Nicholas Street',
		'FromTo': 'Full length: From Rodney Avenue to Dixie Street (120m)',
		'Current': '50',
		'Proposed': '40',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map6-reikorangi.gif',
	...
	'TE HORO BEACH SETTLEMENT - Sylvia Way': [{
		'Road': 'Sylvia Way',
		'FromTo': 'Full length: From Gawler Street to end (118m)',
		'Current': '50',
		'Proposed': '40',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map6-reikorangi.gif',
	...
	'TE HORO BEACH SETTLEMENT - Brendan Drive': [{
		'Road': 'Brendan Drive',
		'FromTo': 'Full length: From Gawler Street end (112m)',
		'Current': '50',
		'Proposed': '40',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map6-reikorangi.gif',
	...
	'TE HORO BEACH SETTLEMENT - Granville Street': [{
		'Road': 'Granville Street',
		'FromTo': 'Full length: From Rodney Avenue to Gawler Street (242m)',
		'Current': '50',
		'Proposed': '40',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map6-reikorangi.gif',
	...
	'TE HORO BEACH SETTLEMENT- Sea Road': [{
		'Road': 'Sea Road',
		'FromTo': 'Full length: From Rodney Avenue to end (84m)',
		'Current': '50',
		'Proposed': '40',
		'Rationale': '40 km/h is the appropriate speed limit for the roads in this beachside residential settlement with short streets where pedestrians share the streets with cars.',
		'ImageUrl': domain + 'globalassets/your-council/projects/kapiti-speed-limits-review/images/map7-ngarara-jacks-bush-smithfield.gif',
